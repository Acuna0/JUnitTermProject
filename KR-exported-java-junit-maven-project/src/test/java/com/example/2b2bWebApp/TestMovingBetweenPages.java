...
public class TestMovingBetweenPages {
  ...
  @Test
  public void testMovingBetweenPages() throws Exception {
    ...
    driver.findElement(By.linkText("Go to Plant Library")).click();
    driver.get("http://ec2-3-14-13-63.us-east-2.compute.amazonaws.com/Search");
    driver.findElement(By.linkText("view personal collection")).click();
    driver.get("http://ec2-3-14-13-63.us-east-2.compute.amazonaws.com/UserPlant");
