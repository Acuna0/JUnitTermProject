...
public class TestCreateUserFail {
  ...
  public void testCreateUserFail() throws Exception {
    ...
    driver.findElement(By.id("first_name")).sendKeys("two");
    driver.findElement(By.id("last_name")).clear();
    driver.findElement(By.id("last_name")).sendKeys("test");
    driver.findElement(By.id("email")).click();
    driver.findElement(By.id("email")).clear();
    driver.findElement(By.id("email")).sendKeys("203kl.21");
    driver.findElement(By.id("password")).click();
    driver.findElement(By.id("password")).clear();
    driver.findElement(By.id("password")).sendKeys("km12d32");
    driver.findElement(By.xpath("//div[@id='app']/button")).click();
    assertEquals("undefined", closeAlertAndGetItsText());
  }
