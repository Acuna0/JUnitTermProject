...
public class TestLoginFail {
  ...
  public void testLoginFail() throws Exception {
    ...
    driver.findElement(By.id("password")).sendKeys("123456789010213i12031ojiansdd");
    driver.findElement(By.xpath("//div[@id='app']/div/div/button")).click();
    assertEquals("Request failed with status code 403", closeAlertAndGetItsText());
    ...
    driver.findElement(By.id("email")).click();
    driver.findElement(By.id("email")).clear();
    driver.findElement(By.id("email")).sendKeys("onetwotest@test.com");
    driver.findElement(By.xpath("//div[@id='app']/div/div/button")).click();
    assertEquals("Request failed with status code 403", closeAlertAndGetItsText());
  }
